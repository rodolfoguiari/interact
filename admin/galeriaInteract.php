...
<div class="col-lg-9 col-md-9 col-sm-9">
    <div class="row">
        <div class="col-md-9">
            <p class="lead text-muted">Galeria do Projeto</p>
        </div>
        <div class="col-md-3">
            <button type="button" class="btn btn-primary width-100-porc" onclick="openSlide()">Adicionar na Galeria</button>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Adicionando na Galeria</h4>
            </div>
                        ...
                        <div class="tab-pane active" id="aba_galeria">
                            ...
                            <div class="row">
                                <div class="col-sm-4 col-sm-offset-4">
                                    <label>Galeria do Projeto (Max. <?php echo MAX_IMG_GALERIA; ?> Imagens)</label>
...
<script type="text/javascript">
    ...
    $("#ds_galeria").on('change', function(e){
        ...
        $.ajax({
            url: '../ajax/ajax.php?acao=salvaGaleriaProjeto',
            cache: false,
            contentType: false,
            processData: false,
            data: data,
    ...
    function visualizarImgProjeto(img){
        
        $("#name_div_slide").html(img);
        $("#input_view_slide").attr("src","../img/galeria/" + img);
    ...
    function delImgProjeto(img){
        
        if(confirm('DESEJA REALMENTE EXCLUIR ESTA IMAGEM ?')){
            
            $.post("../ajax/ajax.php?acao=delImgProjeto",{img:img},
            function(data){
    ...
    function listaSlide(){
        ...
        $.post("../ajax/ajax.php?acao=listaGaleriaProjeto",{},
        function(data){
